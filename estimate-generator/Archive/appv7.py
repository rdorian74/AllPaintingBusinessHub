...
def call_claude_for_formatting(extracted_data):
    ...
    logo_html = ""
    if HAS_LOGO:
        logo_html = f'<img src="file://{LOGO_PATH}" style="height: 75px; width: auto; display: block;">'
        print(f"✅ Logo will be included from: {LOGO_PATH}")
    else:
        logo_html = '<div><div style="font-size: 22pt; font-weight: bold; color: #2B4C7E;">ALL PAINTING LTD.</div><div style="font-size: 10pt; color: #555;">Your Full-Service Painting Company</div></div>'
